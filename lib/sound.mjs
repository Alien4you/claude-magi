...
export const CUES = {
  ...
  /**
   * DERIVED. A rising fifth built on reject's own measured second partial, in
   * its timbre. The source contains no agreement chime — this is designed to
   * read as affirmative against the flat sustained rejection.
   */
  agree: [
    ...note(0, 0.13, [[1688, 0.5], [3376, 0.045]], { attack: 0.006, release: 0.006 }),
    ...note(0.13, 0.49, [[2531, 0.58], [5062, 0.052]], { attack: 0.006, release: RELEASE, decay: 3 }),
  ],
  ...
  /** DERIVED. Final 可決 stamp: the agree figure. */
  approved: [
    ...note(0, 0.13, [[1688, 0.5], [3376, 0.045]], { attack: 0.006, release: 0.006 }),
    ...note(0.13, 0.62, [[2531, 0.58], [5062, 0.052]], { attack: 0.006, release: RELEASE, decay: 2.4 }),
  ],
